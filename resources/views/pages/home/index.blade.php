                               ...
                               <div class="card">
                                <table class="table table-sm">
                                    <thead class="bg-info" style="color: white">
                                      <tr>
                                        <th></th>
                                        <th scope="col" colspan="4" style="text-align: center">{{ $bulan }}</th>
                                        <th></th>
                                      </tr>
                                      <tr>
                                        <th scope="col">LM</th>
                                ...
                                <div class="card">
                                    <table class="table table-sm">
                                        <thead class="bg-info" style="color: white">
                                          <tr>
                                            <th></th>
                                            <th scope="col" colspan="4" style="text-align: center">Minggu 1</th>
                                            <th></th>
                                          </tr>
                                          <tr>
                                            <th scope="col">LM</th>
                               ...
                               <div class="card">
                                <table class="table table-sm">
                                    <thead class="bg-info" style="color: white">
                                      <tr>
                                        <th></th>
                                        <th scope="col" colspan="4" style="text-align: center">Minggu 2</th>
                                        <th></th>
                                      </tr>
                                      <tr>
                                        <th scope="col">LM</th>
                                ...
                                <div class="card">
                                    <table class="table table-sm">
                                        <thead class="bg-info" style="color: white">
                                          <tr>
                                            <th></th>
                                            <th scope="col" colspan="4" style="text-align: center">Minggu 3</th>
                                            <th></th>
                                          </tr>
                                          <tr>
                                            <th scope="col">LM</th>
                               ...
                               <div class="card">
                                <table class="table table-sm">
                                    <thead class="bg-info" style="color: white">
                                      <tr>
                                        <th></th>
                                        <th scope="col" colspan="4" style="text-align: center">Minggu 4</th>
                                        <th></th>
                                      </tr>
                                      <tr>
                                        <th scope="col">LM</th>
